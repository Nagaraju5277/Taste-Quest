...
<h1 className='text-center'>Copyright 2024, Designed & Developed by <span className='text-blue-500'>KANNA NAGARAJU</span>,  All Rights Reserved</h1>
<div  id='icon-box' className='bg-green-500 p-2 rounded-full hover:bg-orange-500 cursor-pointer fixed bottom-12 right-6'>
   ...
   <img src={toparrow} alt="arrow icon" width={28} height={28} />
   </Link>
 </div>
</div>
